package de.hohenheim.realdemocracy.config;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.
                ...
                .antMatchers("/login", "/registrierung","/passwortVergessen", "/usernameVergessen",
                        "/login/home", "/registrierung/login","/passwortVergessen/login","/usernameVergessen/login",
                        "/console/**").permitAll()
