...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.
                ...
                .antMatchers("/login", "/adminLogin", "/register", "/getUsername", "/password",
                        "/login/userHome", "/adminLogin/adminVocab", "/register/login", "/getUsername/login",
                        "/password/changePassword", "/changePassword/login", "/confirmEmail/login",
                        "/confirmEmail/otherEmail", "/console/**").permitAll()
